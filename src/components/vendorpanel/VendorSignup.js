...
const VendorSignup = () => {
  return (
    <section class="py-3 py-md-5 py-xl-8">
      <div class="container" style={{border: '1px solid black',paddingTop:20+"px", paddingBottom:20+"px"}}>
        <div class="row">
          <div class="col-12">
            <div class="mb-5">
          ...
          <div class="col-12 col-lg-10 col-xl-8">
            <div class="row gy-5 justify-content-center">
                ...
                <form action="#!">
                  ...
                  <div class="col-12">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control border-0 border-bottom rounded-0" name="password" id="password" value="" placeholder="Mobile Numer" required/>
                    ...
                    <div class="col-12">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control border-0 border-bottom rounded-0" name="password" id="password" value="" placeholder="Mobile Numer" required/>
                        <label for="password" class="form-label">Your Mail Id</label>
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-floating mb-3">
              ...
              <div class="col-12 col-lg-2 d-flex align-items-center justify-content-center gap-3 flex-lg-column">
                <div class="bg-dark h-100 d-none d-lg-block"  style={{width:1+"px" }}></div>
                <div class="bg-dark w-100 d-lg-none"  style={{height:1+"px"}}></div>
                <div>or</div>
                <div class="bg-dark h-100 d-none d-lg-block"  style={{width:1+"px"}}></div>
                <div class="bg-dark w-100 d-lg-none"  style={{height:1+"px"}}></div>
              </div>
